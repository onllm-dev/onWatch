...
**Measured RAM (all four agents running in parallel):** ~34 MB idle, ~43 MB P95 under continuous load (~4,300 requests in 60s). Single binary, all assets embedded via `embed.FS`.
